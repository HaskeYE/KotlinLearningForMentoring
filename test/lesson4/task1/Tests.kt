...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("девятьсот девяносто три тысячи девятьсот двенадцать", russian(993912))
        assertEquals("сто десять тысяч шестьсот восемьдесят", russian(110680))
        assertEquals("девятьсот сорок тысяч сто десять", russian(940110))
        ...
        assertEquals("сто двадцать тысяч двадцать три", russian(120023))
        assertEquals("двенадцать", russian(12))
        assertEquals("двенадцать тысяч", russian(12000))
        assertEquals("двадцать", russian(20))
        assertEquals("сто двадцать", russian(120))
        assertEquals("сто тысяч сто двадцать пять", russian(100125))
    }
}